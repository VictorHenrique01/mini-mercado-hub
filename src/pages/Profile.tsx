...
  // ➡️ ATUALIZAÇÃO: Adiciona updateSeller
...
    setLoading(true);
    try {
      // 1. Chama a API de atualização
      const updatedSeller = await usersAPI.update(seller.id, formData);
      
      // 2. ➡️ ATUALIZAÇÃO: Atualiza o contexto (e localStorage) com os novos dados
